...
\projectinfo{
  ...
  title={Implementace překladače imperativního jazyka IFJ21}, % Název prezentace / Presentation title (The whole title of the presented work suitably divided into lines that are optically balanced)
  title.footer={Tým 047, varianta I}, % Název prezentace - text zobrazovaný vedle čísla slajdu / Presentation title - displayed next to the slide number (The full title of the presented work, it may be suitably abbreviated to fit the footer)
  author.name={\textbf{Bártů Tomáš}, Janeček Vít,\\ Pham Tony, Vacek Šimon}
}
